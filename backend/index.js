...
let options = [{ label: 'doc', value: 'doc' }, { label: 'docx', value: 'docx' }, { label: 'txt', value: 'txt' }, { label: 'jpeg', value: 'jpeg' }, { label: 'jpg', value: "jpg" }, { label: 'mov', value: 'mov' }, { label: 'mp3', value: "mp3" }, { label: 'mp4', value: 'mp4' }];
